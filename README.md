...
- **Windows Service** installation capability
...
3. Run `install.bat` as Administrator to install as Windows Service
...
Run `uninstall.bat` as Administrator to remove the Windows Service.
...
- Service status visible in Windows Services panel
...
- Installation scripts for Windows Service
